...
<div class="row dum_container">
	<div class="k_cheading">
		<h1><span class="k_greencolor">exhibitor registration – DUM 2019</h1>
	...
	<div class="k_register">
		...
		<p class="k_pleasenote">
			...
			<i class="fa fa-square" aria-hidden="true"></i> For 3 x 2 mtrs booth, 2 volunteer pass and 2 delegate pass will be given to attend the workshop <br>
                       <i class="fa fa-square" aria-hidden="true"></i> For queries write us at <a href="mailto:dum2019@indiasmartgrid.org" style="font-weight: bold;">dum2019@indiasmartgrid.org</a>. 
		</p>
