...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    else
    {
	    ...
	    $subject = "WRITE TO US – DUM 2018 Form Filled By ".$_POST['name'];
...
<div class="row dum_container">
    ...
    <!-- <div class="col-sm-4" style="text-align: left;">
     ...
     <div class="col-sm-12 dum_contact1">
      <a href="">Venue :- Taj Lands End, Mumbai, India</a><br>
    ...
    <div class="dum_contactpart1">
      ...
      <div class="col-sm-6">
        <h1><b><a href="https://www.tatapower.com/" target="_blank">The Tata Power Company Ltd., Mumbai</a></b></h1>
        <a href="">Email :- dum2018@tatapower.com</a><br>
        <a href="">Contact No. :- +91- 9223355798</a><br>
      </div>
    </div>
