...
<div class="row k_inbanner">
	...
	<div class="k_cheading">
		<h1><span class="k_greencolor">3D DIGITAL EXHIBITION BOOTH AT DUM 2021</span> </h1>
		<img src="images/kborder_bottom.png" alt="">
	</div>
	<p class="k_p">Utilities and select Technology Providers have the option to exhibit their products and solutions in the Booths which will give a unique experience of interacting with visitors and explaining about their offerings.</a>
 </p>
 <p class="k_p">Exhibition Booth is available in 3D PLATINUM and 3D GOLD categories</p>
