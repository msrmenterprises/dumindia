...
.buckyroberts_dum_contactus_icons_div span a{
...
.k_confirmed_als li {
    flex: 1 1 150px; /* Grow to fit, but start at 150px */
    text-align: center;
    margin: 10px;
}
...
<div class="row k_container k_at_glace kh1_heading">

	<div class="k_cheading">

		<h1>DUM 2026 <span class="k_greencolor">at a Glance</span> </h1>
	...
	<strong>ISGF has the pleasure of inviting key stakeholders in the DISCOM domains to the 10th Edition of Distribution Utility Meet <a href="http://www.dumindia.in/">(DISTRIBUTION UTILITY MEET )</a> at The Lalit Hotel, Jaipur, Rajasthan, India on 27-28 October 2026. DUM 2026 will provide a unique platform for all the DISCOM community to share each other's experiences in dealing with efforts towards energy transition, grid modernization and digitalization on a fast track as we leapfrog towards a Net Zero power sector in India. In the post pandemic world, it is imperative that utilities do not make the same mistakes but learn from each other, and from global expertise/experiences. Experts from leading utilities from the USA, Europe, Japan and South Korea will be invited to participate in DUM 2026 and share their valuable experiences.</strong>
		</strong></p>

		<div class="k_cheading">

		<h1>DUM 2026 <span class="k_greencolor">PROGRAM</span> </h1>
		...
		<img src="images/2026/ProgramStructurev3.jpg" alt="Program Structure for Dum 2024" width="100%">
	<!--<img src="http://dumindia.in/DUM 2023 PROGRAM.png" width="780" height="295"></img>-->

</div>

<div class="row img_bg_k_ho">

	<img src="images/k_about_bg.png" class="img-responsive" alt="">
...
<div class="row k_container k_key_themes" style="background: #fff;">
	...
	<div class="k_cheading">
		...
		<h1>utility & government<span class="k_greencolor"> participation</span> </h1>
   ...
   <!-- 	<div class="col-sm-5 img-part"><img src="images/k_keythemes.jpg" alt=""></div> -->
	...
	<!-- <a href="utility-registration.php" class="k_read_more">Register now</a> -->		
...
<div class="row k_container k_key_themes" style="background: #fff;">
	...
	<div class="k_cheading">
		...
		<h1>Industry  <span class="k_greencolor"> Participation</span> </h1>
...
<div class="k_cheading k_white_haeding">
	...
	<ul class="k_confirmed_als">
		...
		<li><a href="https://energy.rajasthan.gov.in/jdvvnl/#/home/dptHome/185" target="_blank"><img src="images/utilities2019/jvvnl.png" style="height:100px;">Jodhpur Vidyut Vitran Nigam Limited - पोर्टल, राजस्थान सरकार</a></li>
...
<!--<div class="k_cheading k_white_haeding">
	...
	<ul class="k_confirmed_als"> 
	        ...
	        <li><a href="https://www.cesc.co.in/home" target="_blank"><img src="/images/CESC_cohost.jpg" alt="" style="border: 2px solid #aeb4b2; height: 100px;">CESC Kolkata</a></li>
...
<li><a href="https://www.pgvcl.com/" target="_blank"><img src="images/utilities2019/2. PGVCL.png" style="height:155px;">Paschim Gujarat Vij Company Limited</a></li>                                                			
	...
	<div class="k_cheading k_white_haeding">
       ...
       <ul class="k_confirmed_als">
	        <li><a href="" target="_blank"><img src="images/utilities2019/adani.png" style="height:105px;">Adani Electricty</a></li>
		    ...
		    <li><a href="https://energy.rajasthan.gov.in/content/raj/energy-department/avvnl/en/home.html" target="_blank"><img src="images/Ajmer Vidyut Vitran Nigam Limited.jpg" style="height:110px;">Ajmer Vidyut Vitran Nigam Limited</a></li>
	        ...
	        <li><a href="https://ioagpl.com/" target="_blank"><img src="images/Indian Oil-Adani Gas Pvt. Ltd.png">Indian Oil-Adani Gas Pvt Ltd.</a></li>
            <li><a href="https://energy.rajasthan.gov.in/jvvnl/#/home/dptHome" target="_blank"><img src="images/Jaipur Vidut Vitran Nigam Limited logo.png" style="height: 100px;">Jaipur Vidyut Vitran Nigam Limited</a></li>			
			...
			<li><a href="https://www.torrentgas.com/frontend/web/index.php/site/index" target="_blank"><img src="images/utilities2019/torrent-gas.PNG" style="height:100px;">Torrent Gas Private Limited</a></li>
			<li><a href="" target="_blank"><img src="images/utilities2019/southpower.png">Telengana Southern Power Distribution Ltd</a></li>
			<li><a href="https://www.torrentpower.com/index.php/site/indexs" target="_blank"><img src="images/images_2018/Torrent.png" style="border: 2px solid #aeb4b2;">Torrent Power</a></li>
			<li><a href="https://www.tangedco.gov.in/" target="_blank"><img src="images/utilities2019/Tamil Nadu Generation and Distribution Corporation Limited.png" style="height:150px;">Tamil Nadu Generation and Distribution Corporation Limited</style></a></li>
			<li><a href="https://www.tpnodl.com/" target="_blank"><img src="images/TPNODL.jpg" style="height: 150px;">Tata Power Northern Odisha Distribution Limited</a></li>
			<li><a href="https://www.tpsouthernodisha.com/" target="_blank"><img src="images/TPSODL.jpg" style="height: 150px;">Tata Power Southern Odisha Distribution Limited</a></li>
			<li><a href="https://www.tpcentralodisha.com/" target="_blank"><img src="images/TPCODL.jpg" style="height: 150px;">Tata Power Central Odisha Distribution Limited</a></li>
			<li><a href="https://www.tpwesternodisha.com/" target="_blank"><img src="images/TPWODL.jpg" style="height: 150px;">Tata Power Western Odisha Distribution Limited</a></li>
			<li><a href="" target="_blank"><img src="images/utilities2019/tatapower.png" style="height: 150px;">The Tata Power Company Limited</a></li>
			...
			<li><a href="https://think-gas.com/" target="_blank"><img src="images/utilities2019/think-gas.png">Think Gas Distribution Private Limited</a></li>
			...
			<li><a href="" target="_blank"><img src="images/utilities2019/ugvcl.png" style="height: 150px;">UGVCL</a></li>
			<li><a href="https://www.uhbvn.org.in/web/portal/home" target="_blank"><img src="images/Uttar Haryana Bijli Vitran Nigam Logo.png" style="height:155px;">Uttar Haryana Bijli Vitran Nigam</a></li>
			<li><a href="https://www.upcl.org/" target="_blank"><img src="images/Uttarakhand Power Corporation Limited logo.jpg" style="height:155px;">Uttarakhand Power Corporation Limited </a></li>
			<li><a href="https://uppcl.org/uppcl/hi/" target="_blank"><img src="images/utilities2019/5. UPPCL.png" >Uttar Pradesh Power Corporation</a></li>
		    <li><a href="https://www.wbsedcl.in/irj/go/km/docs/internet/new_website/Home.html" target="_blank"><img src="images/utilities2019/logo (2).png" style="height:155px;">West Bengal State Electricity Distribution Company Limited</a></li>
		   <li><a href="https://www.dhbvn.org.in/web/portal/home" target="_blank"><img src="images/DHBVN_Logo.jpg" style="height:155px;">Dakshin Haryana Bijli Vitran Nigam</a></li>
			<li><a href="https://www.dvc.gov.in/" target="_blank"><img src="images/1. Damodar Valley.png" style="height: 155px;">Damodar Valley</a></li>
			<li><a href="https://energy.rajasthan.gov.in/content/raj/energy-department/jodhpur-vidyut-vitran-nigam-limited/en/home.html" target="_blank"><img src="images/utilities2019/Jodhpur Vidyut Vitran Nigam Limited.jpg">Jodhpur Vidyut Vitran Nigam Limited</a></li>
			<li><a href="https://www.tatasteeluisl.com/customer-service-portal-launch.asp" target="_blank"><img src="images/Jamshedpur Utilities & Services Company Limited.png">Jamshedpur Utilities & Services Company Limited (JUSCO)</a></li>
			<li><a href="https://jbvnl.co.in/" target="_blank"><img src="images/Jharkhand Bijli Vitran Nigam Limited.jpg">Jharkhand Bijli Vitran Nigam Limited </a></li>
...
<!-- EXHIBITORS starts here -->
<div class="row k_partiexh">
	<div class="k_cheading k_white_haeding">
		<h1><span class="k_greencolor">Previous Edition </span> <span style="color: black;">Partners and Exhibitors of DUM</span> </h1>
		<img src="images/kborder_bottom.png" alt="">
	</div>
       <ul class="k_confirmed_als">
			<li><a href="" target="_blank"><img src="images/utilities2019/adani.png" style="height:100px;">Adani Electricty</a></li>
			...
			<li><a href="https://www.cuculus.com/" target="_blank"><img src="/images/Cuculus.png" style="border: 1px solid #aeb4b2; height:100px;">Cuculus & Shubhashree </a></li>
		...
		<li><a href="https://fsr.eui.eu/" target="_blank"><img src="images/FSR 200 X 135.jpg" alt="" style="height: 135px;">EUI-FSR</a></li>
		<li><a href="https://www.epri.com/" target="_blank"><img src="images/epri.jpg" alt="" style="height: 135px;">EPRI, USA</a></li>
			<li><a href="https://fluentgrid.com/" target="_blank"><img src="/images/FluentGrid.jpg" style="border: 1px solid #aeb4b2; height:123px;">Fluentgrid Limited </a></li>   
			...
			<li><a href="https://www.gridspertise.com/" target="_blank"><img src="/images/Gridspertise_claim_flag_flat_color (1).jpg" style="height:120px;">Gridspertise </a></li>
			<li><a href="" target="_blank"><img src="images/utilities2019/hescom.png">HESCOM</a></li>
			<li><a href="https://www.hplindia.com/" target="_blank"><img src="/images/HPL Electric & Power Limited Logo.png" style="border: 1px solid #aeb4b2; height:123px;">HPL Electric & Power Limited </a></li>
			<li><a href="" target="_blank"><img src="images/utilities2019/himachal.png">Himachal Pradesh Electricity Board</a></li>
			 <li><a href="https://www.ideainfinityit.com/" target="_blank"><img src="/images/idea-infinity.jpg" style="border: 1px solid #aeb4b2; height:100px;">Idea Infinity </a></li>
			...
			<li><a href="https://www.aspentech.com/en" target="_blank"><img src="/images/OSI.jpg" style="border: 1px solid #aeb4b2; height:123px;">OSI , An Aspentech business </a></li>   
			  <li><a href="" target="_blank"><img src="images/utilities2019/paschimstate.png">Paschimanchal Vidyut Vitran Nigam Ltd</a></li>
			<li><a href="" target="_blank"><img src="images/utilities2019/paschimm.png">Paschim Gujarat Vij Company Ltd.</a></li>
			<li><a href="" target="_blank"><img src="images/utilities2019/pspcl.png">Punjab State Power Corporation  Ltd</a></li>
			<li><a href="https://redplanetgrp.com/" target="_blank"><img src="/images/kiggs.jpg">Redplanet Spatial Solutions (India) Private Limited </a></li>
			<li><a href="" target="_blank"><img src="images/utilities2019/purvanchalvidhut.png">Purvanchal Vidyut Vitran Nigam Ltd</a></li>
			<li><a href="" target="_blank"><img src="images/utilities2019/rec.png">Rural Electrification Corporation Power Distribution Company Ltd</a></li>
			<li><a href="https://www.rti.org/" target="_blank"><img src="/images/rti.jpg" style="height:120px;">RTI INTERNATIONAL</a></li>
			<li><a href="" target="_blank"><img src="images/utilities2019/southern.png">Southern Electricity Supply Company of Orissa Ltd</a></li>
			<li><a href="https://shyamindus.com/" target="_blank"><img src="/images/Shyam Industries.jpg" style="border: 1px solid #aeb4b2; height:123px;">Shyam Indus Power Solutions </a></li>
			<li><a href="" target="_blank"><img src="images/utilities2019/tatapowerdlll.png" style="height: 100px;">Tata Power - DDL</a></li>
			...
			<li><a href="" target="_blank"><img src="images/utilities2019/ugvcl.png" style="height: 100px;">UGVCL</a></li>
...
<!-- time remaining starts here -->
<!-- <div class="row k_time_stamp">
	<div class="k_cheading">
		<h1><span class="k_greencolor">Time remaining</span> </h1>
		<img src="images/kborder_bottom.png" alt="">
	</div>
	<div class="clock"></div>
...
@media (max-width: 768px) {
	...
	.k_container { padding-top: 18px; padding-bottom: 18px; }
            ...
            <div class="col-sm-12 buckyroberts_dum_contactus_icons_div">
				<h1 style="color: #8cc63e; text-align: center;">DUM 2023</h1>
			</div> 
			...
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div" style="color: #ffffff; text-align: center;">
               ...
               <span><a href="http://dumindia.in/brochure.php" style="color: #ffffff;">Download Brochure</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				...
				<span><a href="http://dumindia.in/speaker2023.php" style="color: #ffffff;">Speakers</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<!--<span><a href="http://dumindia.in/gallery.php" style="color: #ffffff;">Gallery</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
			    <span><a href="http://dumindia.in/presentations2022.php" style="color: #ffffff;">Presentations</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				-->
			</div>			
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div">
				<h1 style="color: #8cc63e; text-align: center;">DUM 2022</h1>
			</div> 
			...
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div" style="color: #ffffff; text-align: center;">
                ...
                <span><a href="http://dumindia.in/presentations2022.php" style="color: #ffffff;">Presentations</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/brochure.php" style="color: #ffffff;">Download Brochure</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/speaker2022.php" style="color: #ffffff;">Speakers</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/organiser.php" style="color: #ffffff;">Organiser</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/gallery.php" style="color: #ffffff;">Gallery</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
			
			</div>
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div">
				<h1 style="color: #8cc63e; text-align: center;">DUM 2021</h1>
			</div> 
			...
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div" style="color: #ffffff; text-align: center;">
				...
				<span><a href="http://dumindia.in/confirmed-exhibitor.php" style="color: #ffffff;">Confirmed Exhibitors</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/confirmed_utility.php" style="color: #ffffff;">Confirmed Utilities</a></span>&nbsp;&nbsp; | &nbsp; &nbsp;
                	<span><a href="http://dumindia.in/presentations2021.php" style="color: #ffffff;">Presentations</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/brochure.php" style="color: #ffffff;">Download Brochure</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/speaker2021.php" style="color: #ffffff;">Speakers</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/organiser.php" style="color: #ffffff;">Organiser</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/gallery-2021.php" style="color: #ffffff;">Gallery</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
			</div>
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div">
				<h1 style="color: #8cc63e; text-align: center;">DUM 2020</h1>
			</div>
			
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div" style="color: #ffffff; text-align: center;">
				
				<span><a href="http://dumindia.in/agenda.php" style="color: #ffffff;">Agenda</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2020/key-objective.php" style="color: #ffffff;">Key Objectives</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2020/key-themes.php" style="color: #ffffff;">Key Themes</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/confirmed_utility.php" style="color: #ffffff;">Confirmed Utilities</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/confirmed-exhibitor.php" style="color: #ffffff;">Confirmed Exhibitors</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/presentations2020.php" style="color: #ffffff;">Presentations</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2020/DUM 2020 Brochure Design.pdf" style="color: #ffffff;">Download Brochure</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2020/speaker2020.php" style="color: #ffffff;">Speaker</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/organiser.php" style="color: #ffffff;">Organiser</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/gallery.php" style="color: #ffffff;">Gallery</a></span>
				</div>
			
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div">
				<h1 style="color: #8cc63e; text-align: center;">DUM 2019</h1>
			</div>
			
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div" style="color: #ffffff; text-align: center;">
				<span><a href="http://dumindia.in/dumindia2019/agenda.php" style="color: #ffffff;">Agenda</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<!-- <span><a href="contact_us-2017.php" style="color: #ffffff;">Contact Us</a></span>&nbsp;&nbsp; | &nbsp;&nbsp; -->
				<span><a href="http://dumindia.in/dumindia2019/key_objective.php" style="color: #ffffff;">Key Objectives</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2019/key_themes.php" style="color: #ffffff;">Key Themes</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				
				<span><a href="http://dumindia.in/dumindia2019/confirmed-exhibitor.php" style="color: #ffffff;">Confirmed Exhibitors</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2019/confirmed_utility.php" style="color: #ffffff;">Confirmed Utilities</a></span>&nbsp;&nbsp; | &nbsp; &nbsp;
                	<span><a href="http://dumindia.in/dumindia2019/presentations.php" style="color: #ffffff;">Presentations</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2019/dumpdf/DUM_2019_Brochure_Design.pdf" style="color: #ffffff;">Download Brochure</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2019/speakers2019.php" style="color: #ffffff;">Speakers</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2019/organiser.php" style="color: #ffffff;">Organiser</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2019/gallery.php" style="color: #ffffff;">Gallery</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2019/hotels.php" style="color: #ffffff;">Hotels</a></span>
			</div>
			
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div">
				<h1 style="color: #8cc63e; text-align: center;">DUM 2018</h1>
			</div>
			
			<div class="col-sm-12 buckyroberts_dum_contactus_icons_div" style="color: #ffffff; text-align: center;">
				<span><a href="http://dumindia.in/dumindia2018/agenda.php" style="color: #ffffff;">Agenda</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<!-- <span><a href="contact_us-2017.php" style="color: #ffffff;">Contact Us</a></span>&nbsp;&nbsp; | &nbsp;&nbsp; -->
				<span><a href="http://dumindia.in/dumindia2018/confirmed_utility.php" style="color: #ffffff;">Confirmed Utilities</a></span>&nbsp;&nbsp; | &nbsp; &nbsp;
				<span><a href="http://dumindia.in/dumindia2018/dumpdf/DUM_2019_Brochure_Design.pdf" style="color: #ffffff;">Download Brochure</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2018/knowledge.php" style="color: #ffffff;">Knowledge</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2018/site_visit.php" style="color: #ffffff;">Site Visit</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2018/speakers2018.php" style="color: #ffffff;">Speakers</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2018/organiser.php" style="color: #ffffff;">Organiser</a></span>&nbsp;&nbsp; | &nbsp;&nbsp;
				<span><a href="http://dumindia.in/dumindia2018/gallery.php" style="color: #ffffff;">Gallery</a></span>
			</div>
			...
			<style>
			#k_contact_us_section {
				background-color: #141414;
				padding: 30px 8%;
				margin-top: 20px;
				text-align: center;
			}
			#k_contact_us_section h1,
			#k_contact_us_section h1 a {
				color: #8cc63e;
				text-align: center;
			}
			#k_contact_us_section .buckyroberts_dum_contactus_icons {
				text-align: center;
				color: #ffffff;
				margin-bottom: 20px;
			}
			#k_contact_us_section .buckyroberts_dum_contactus_icons h4 .fa {
				color: #8cc63e;
				padding: 8px 7px;
				font-size: 16px;
				border-radius: 50%;
			...
			#k_contact_us_section .buckyroberts_dum_contactus_icons p,
			#k_contact_us_section .buckyroberts_dum_contactus_icons p a {
				color: #ffffff;
				text-decoration: none;
			}
			#k_contact_us_section .buckyroberts_dum_contactus_icons p a:hover {
				color: #8cc63e;
			}
			...
			<div id="k_contact_us_section" class="row">
