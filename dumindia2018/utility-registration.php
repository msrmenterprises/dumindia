	...
	if(isset($_POST['register_button']))
  	{
		...
		if($insert_query)
		{
		      ...
		      $subject="UTILITY REGISTRATION – DUM 2018 Form Filled By ".$_POST['u5'];
...
<div class="row dum_container">
	<div class="k_cheading">
		<h1><span class="k_greencolor">UTILITY REGISTRATION – DUM 2018</h1>
	...
	<div class="k_register">
		...
		<p class="k_pleasenote">
			<b>Please note : </b> <br>
			<i class="fa fa-square" aria-hidden="true"></i> Utility Participation for DUM 2018 is complimentary.  <br>
                       <i class="fa fa-square" aria-hidden="true"></i> For Utility Exhibition Booth and other queries, please write us at <a href="mailto:dum2018@indiasmartgrid.org" style="font-weight: bold;">dum2018@indiasmartgrid.org</a>. 
		</p>
	</div>
<br>
<br>
